...
const addresses = [
  {
    name: "Anshul Patel",
    street: "h.no 5 jhgs ,sjd jshgdshg sjds.",
    phone: "1113242434344",
    pincode: "121344",
    email: "hagshas@12gmail.com",
    city: "Banglaore",
  },
  {
    name: "Adbsdjsjd Patel",
    street: "h.nasdabjasdo 5 jhgs ,sjd jshgdshg sjds.",
    phone: "2424355656546",
    pincode: "324353",
    email: "adakaj32asd@12gmail.com",
    city: "koitmture",
  },
];
    ...
    <div className="mx-auto  max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className="lg:col-span-3  ">
          <form className="px-5 bg-white py-6 my-12">
